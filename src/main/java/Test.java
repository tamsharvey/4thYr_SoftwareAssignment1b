...
public class Test
{
    public static void main(String[] args)
    {
        ...
        s1.setCourses(new ArrayList<>(List.of(c1, c2)));
        s2.setCourses(new ArrayList<>(List.of(c2, c3)));
        s3.setCourses(new ArrayList<>(List.of(c1, c3)));

        // Assigning modules to students
        s1.setModules(new ArrayList<>(List.of(m1, m2)));
        s2.setModules(new ArrayList<>(List.of(m2, m3)));
        s3.setModules(new ArrayList<>(List.of(m1, m3)));

        // Assigning students to modules
        m1.setAssignedStudents(new ArrayList<>(List.of(s1, s3)));
        m2.setAssignedStudents(new ArrayList<>(List.of(s1, s2)));
        m3.setAssignedStudents(new ArrayList<>(List.of(s2, s3)));

        // Assigning courses to modules
        m1.setCourseAssociated(new ArrayList<>(List.of(c1, c2)));
        m2.setCourseAssociated(new ArrayList<>(List.of(c2, c3)));
        m3.setCourseAssociated(new ArrayList<>(List.of(c1, c3)));

        // Assigning students to courses
        c1.setStudents(new ArrayList<>(List.of(s1, s3)));
        c2.setStudents(new ArrayList<>(List.of(s1, s2)));
        c3.setStudents(new ArrayList<>(List.of(s2, s3)));

        // Assigning modules to courses
        c1.setModules(new ArrayList<>(List.of(m1, m3)));
        c2.setModules(new ArrayList<>(List.of(m1, m2)));
        c3.setModules(new ArrayList<>(List.of(m2, m3)));
